...
const ModernHomePage = () => {
  return (
    <div className="min-h-screen bg-white pt-32">
      ...
      <Navbar /> 
      {/* Hero Section */}
      <section className="relative h-[500px] md:h-[600px] rounded-3xl mx-8 md:mx-16 mb-16 overflow-hidden">
        <div className="absolute inset-0 bg-[#1a2e44] rounded-3xl">
          {/* This would be a background image in production */}
          <div className="absolute right-0 top-0 bottom-0 w-2/3 bg-cover bg-center"
        ...
        <div className="relative z-10 text-white p-12 md:p-16 max-w-2xl">
          <p className="text-sm tracking-widest mb-4 uppercase">Crafting Tomorrow's Living Spaces</p>
      ...
      {/* Dream Build Section */}
      <section className="py-16 px-8 md:px-16 text-center mb-24">
        <div className="max-w-4xl mx-auto">
          ...
          <Link to="/contact"   className="bg-black text-white px-6 py-2 rounded-lg hover:bg-gray-800 transition-colors">
            Get in touch
          </Link>
        </div>
  ...
  <Link 
    to="/portfolio"
    className="relative group rounded-3xl overflow-hidden h-[300px] cursor-pointer"
  >
    <img 
    ...
    />
    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition duration-700">
      <span className="text-white text-2xl font-semibold tracking-wide">PORTFOLIO</span>
    </div>
  </Link>
  ...
  >
    ...
    />
    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition duration-700">
      <span className="text-white text-2xl font-semibold tracking-wide">ESTIMATES</span>
    </div>
  </Link>
      ...
      {/* Inclusions Section */}
      <section className="py-16 px-8 md:px-16 mb-24">
        <div className="bg-gray-900 text-white rounded-3xl overflow-hidden">
          ...
          <div className="md:w-1/2 p-6 md:p-10 flex flex-col justify-center">
              ...
              <div>
                <Link to="/inclusions" className="border border-white text-white px-8 py-3 inline-block hover:bg-white hover:text-black transition-colors">
                  View Inclusions
                </Link>
              </div>
            </div>
            <div className="md:w-1/2 min-h-[200px]">
              <img 
     ...
     {/* Services Section */}
    <section id="services" className="py-16 px-8 md:px-16 mb-24">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl mb-12 text-center">Our Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {serviceCategories.map((service) => (
            <ServiceCard
              ...
              icon={getServiceIcon(service.id)} // This function will be added
            />
          ))}
        </div>
      </div>
      ...
      {/* CTA Section */}
      <section className="py-16 px-8 md:px-16 mb-24 bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors">Custom Homes</a></li>
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors">Renovations</a></li>
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors">Commercial</a></li>
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors">Consulting</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors">Projects</a></li>
              <li><a href="#" className="text-gray-600 hover:text-black transition-colors">Testimonials</a></li>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-2">info@m1bconstruction.com</p>
